...
### Tekstfarger
- Primær tekst: #1A1A1A på lys, #F4F0E8 på mørk
- Sekundær tekst: #4A4A4A
- Dempet tekst: #8A8A8A
...
Stil-stikkord: editorial, varmt, italiensk-håndverk-vibrant, premium-uten-å-skryte, funksjonelt.
